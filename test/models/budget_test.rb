...
class BudgetTest < ActiveSupport::TestCase
  ...
  test "name formats month year in pt-BR for standard monthly budgets" do
    budget = Budget.create!(
      family: @family,
    ...
    I18n.with_locale(:"pt-BR") do
      assert_equal "maio de 2026", I18n.l(budget.start_date, format: :month_year)
      assert_equal "maio de 2026", budget.name
    end
  end
