class Period
  ...
  def label
    if key
      I18n.t("periods.#{key}.label", default: key_metadata&.fetch(:label, "Custom Period"))
    else
  ...
  def label_short
    if key
      I18n.t("periods.#{key}.label_short", default: key_metadata&.fetch(:label_short, "Custom"))
    else
  ...
  def comparison_label
    if key
      I18n.t("periods.#{key}.comparison_label", default: key_metadata&.fetch(:comparison_label, "vs. previous period"))
    else
