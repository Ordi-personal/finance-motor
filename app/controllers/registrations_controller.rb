class RegistrationsController < ApplicationController
  ...
  before_action :sanitize_plan_param, only: :create
  ...
  private
    ...
    def sanitize_plan_param
      # Avoid passing unsupported plan attribute to Family in older deployments.
      params[:user]&.delete(:plan)
      params[:user]&.dig(:family_attributes)&.delete(:plan)
    end
