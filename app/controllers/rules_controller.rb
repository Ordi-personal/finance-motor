class RulesController < ApplicationController
  ...
  def apply
    ...
    redirect_back_or_to rules_path, notice: t("rules.flash.activated", resource_type: @rule.resource_type.humanize)
  end
  ...
  def update
    if @rule.update(rule_params)
      respond_to do |format|
        format.html { redirect_back_or_to rules_path, notice: t("rules.flash.updated") }
        format.turbo_stream { stream_redirect_back_or_to rules_path, notice: t("rules.flash.updated") }
      end
    else
  ...
  def destroy
    @rule.destroy
    redirect_to rules_path, notice: t("rules.flash.deleted")
  end

  def destroy_all
    Current.family.rules.destroy_all
    redirect_to rules_path, notice: t("rules.flash.all_deleted")
  end
