...
Rails.application.routes.draw do
  ...
  get "/auth/sso", to: "auth/sso#callback"  # SSO from Ordi app (JWT-based iframe login)
  ...
  namespace :api do
    namespace :v1 do
      ...
      resource :preferences, only: %i[show update], controller: :preferences  # Ordi: sync user preferences via API
